  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="trailer-url">Embed Trailer URL</Label>
          <Input
            id="trailer-url"
      ...
      <div className="space-y-4">
        ...
        {episodes.map((episode, episodeIndex) => (
          <div key={episode.id} className="border rounded-md p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  type="text"
                  value={episode.title}
                  onChange={(e) => updateEpisode(episode.id, { ...episode, title: e.target.value })}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateEpisode(episode.id, { ...episode, duration: e.target.value })}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) => updateEpisode(episode.id, { ...episode, description: e.target.value })}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateEpisode(episode.id, { ...episode, videoUrl: e.target.value })}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => updateEpisode(episode.id, { ...episode, thumbnailUrl: e.target.value })}
                  className="bg-background/50 border-border/50 focus:border-primary"
                  required
                />
              </div>
